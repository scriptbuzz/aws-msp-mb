...
|---|---|---|---|---|---|---|
| **Release Management** (OPS06) | Cloud Ops | 🟡 design + scaffold | network, ecr, iam, ecs-service, codedeploy-bluegreen, pipeline | `infra/environments/*` | `docs/evidence/release-management/` | [RELEASE_MANAGEMENT_DESIGN.md](RELEASE_MANAGEMENT_DESIGN.md) · [BRANCH_AND_RELEASE_STRATEGY.md](BRANCH_AND_RELEASE_STRATEGY.md) |
...
*Design-only — nothing provisioned yet.*
